    ...
    <div class="container">
        ...
        <div class="row pt-5">
            ...
            <div class="col-md-6 col-lg-3 mb-4">
                ...
                <div class="mb-4 position-relative">
                    ...
                    <a href="post-single-3.html" class="btn-link text-white fw-normal">How did we get here? The
                        history
                        of the business told through tweets</a>
                    <ul class="nav nav-divider align-items-center small mt-2 text-body-secondary">
                        <li class="nav-item position-relative">
                            <div class="nav-link">by <a href="#"
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                ...
                <ul class="nav flex-column text-primary-hover">
                    <li class="nav-item"><a class="nav-link pt-0" href="#"><i
                                class="fab fa-whatsapp fa-fw me-2"></i>WhatsApp</a>
                    </li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="#"><i class="far fa-bell fa-fw me-2"></i>Website
                            Notifications</a></li>
                    <li class="nav-item"><a class="nav-link" href="#"><i class="far fa-envelope fa-fw me-2"></i>Newsletters</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#"><i
                                class="fas fa-headphones-alt fa-fw me-2"></i>Podcasts</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-4">
                ...
                <div class="row g-2">
                    <div class="col">
                        <a href="#"><img class="w-100" src="{{ asset('assets/images/app-store.svg') }}"
                                         alt="app-store"></a>
                    </div>
                    <div class="col">
                        <a href="#"><img class="w-100" src="{{ asset('assets/images/google-play.svg') }}"
                                         alt="google-play"></a>
                    </div>
                </div>
            </div>
